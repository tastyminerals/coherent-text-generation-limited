...
cmd:argument("-epredictor","specify saved epredictor checkpoint to load the parameters from")
...
for topic_id,seedtext in ipairs(seeds) do
  local call = 'th sampler.lua '..opt.modelfile..' '..opt.epredictor..' '..opt.seedfile..' --seedtext "'..seedtext..'" --topic '..topic_id..params
