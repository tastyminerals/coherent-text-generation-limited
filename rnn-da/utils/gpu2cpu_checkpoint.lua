...
-- local imports
custom_classes = {
    'require "model.Linear"',
    'require "model.ParallelTable"',
    'require "model.SplitTable"',
    'require "model.Linear"',
    'require "model.GRU"',
    'require "model.GRU_mod"',
    'require "model.GRU_mod2"',
    'require "model.CAddTable"',
    'require "model.ZipTable"',
    'require "model.GRU_nodrop"',
    'require "model.GRU_mod_nodrop"'
}

for i,reqstr in ipairs(custom_classes) do
    local status = pcall(loadstring(reqstr))
    print(reqstr, status)
end
